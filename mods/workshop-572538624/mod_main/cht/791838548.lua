GLOBAL.STRINGS.NAMES.ENGINEER = "工程師"
GLOBAL.STRINGS.CHARACTER_TITLES.engineer = "和藹可親的人"
GLOBAL.STRINGS.CHARACTER_NAMES.engineer = "戴爾‧科納亨爾"
GLOBAL.STRINGS.CHARACTER_DESCRIPTIONS.engineer = "*可以建造自己的各種玩意兒\n*帶著他自己的扳手和安全帽\n*熱愛科學"
GLOBAL.STRINGS.CHARACTER_QUOTES.engineer = "\"我解決實際問題。\""
GLOBAL.STRINGS.CHARACTERS.ENGINEER = nil

--Scrap
STRINGS.NAMES.SCRAP = "殘留金屬"
_G.ChinesePlus.RenameRecipe("SCRAP", "殘留金屬")

_G.ChinesePlus.RenameTab("Construction", "建造")

STRINGS.CHARACTERS.GENERIC.DESCRIBE.SCRAP = "凌亂的金屬廢料零件。"
...
_G.ChinesePlus.RenameRecipe("EHARDHAT", "這是一頂很硬的帽子。")
...
--Sentry
GLOBAL.STRINGS.NAMES.ESENTRY_ITEM = "步哨槍"
_G.ChinesePlus.RenameRecipe("ESENTRY", "建造一個哨兵！")

GLOBAL.STRINGS.NAMES.ESENTRY = "步哨槍"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.ESENTRY = "我希望它不會打我！"
...
--Dispenser
GLOBAL.STRINGS.NAMES.DISPENSER_ITEM = "補給站"
_G.ChinesePlus.RenameRecipe("DISPENSER", "建造一個補給站。")

GLOBAL.STRINGS.NAMES.DISPENSER = "補給站"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.DISPENSER = "似乎足夠健康了。"
...
--Teleporter
GLOBAL.STRINGS.NAMES.ETELEPORTER_ITEM = "傳送器入口"
_G.ChinesePlus.RenameRecipe("ETELEPORTER", "傳送走了。")

GLOBAL.STRINGS.NAMES.ETELEPORTER = "傳送器入口"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.ETELEPORTER = "傳送應該很有用。"
...
--Exit
GLOBAL.STRINGS.NAMES.ETELEPORTER_EXIT_ITEM = "傳送器出口"
_G.ChinesePlus.RenameRecipe("ETELEPORTER_EXIT", "傳送走了。")

GLOBAL.STRINGS.NAMES.ETELEPORTER_EXIT = "傳送器出口"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.ETELEPORTER_EXIT = "傳送應該很有用。"
...
_G.ChinesePlus.RenameRecipe("TF2WRENCH", "要像一個男人，矮子。")

--GLOBAL.STRINGS.CHARACTERS.ENGINEER.DESCRIBE.TF2WRENCH = "I'm gonna tear you down, junior!"
GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.TF2WRENCH = "這是一個扳手，用於修理東西。"
...
--Gibus
GLOBAL.STRINGS.NAMES.GIBUS = "幽靈摺疊禮帽"
_G.ChinesePlus.RenameRecipe("GIBUS", "不是所有帽子裡最經典的。")

GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.GIBUS = "多麼古怪的帽子。"
...
GLOBAL.MATERIALS.SCRAP = "殘留金屬"
_G.ChinesePlus.RenameAction("DESTINATION","傳送")

GLOBAL.STRINGS.CHARACTERS.GENERIC.DESCRIBE.ENGINEER =
{
  GENERIC = "你好, %s!",
  ATTACKER = "%s 把那把扳手緊緊地握著...",
  MURDERER = "凶手!",
  REVIVER = "%s, 總是在支援。",
  GHOST = "最好找個復活裝置。這裡不能少了這麼科學的人。",
  FIRESTARTER = "燒那個不是很科學, %s.",
}
