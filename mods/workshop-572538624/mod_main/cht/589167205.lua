...
s.CHARACTER_TITLES.spy = "無所不在的壞人"
s.CHARACTER_NAMES.spy = "間諜"
s.CHARACTER_DESCRIPTIONS.spy = "*他有信賴的隱形裝置\n*喜歡用他獨特的刀\n*討厭腐敗食物"
s.CHARACTER_QUOTES.spy = "\"我從來沒有真的在你這邊。\""
...
s.CHARACTERS.GENERIC.DESCRIBE.INVISWATCH = "多麼科學的噩夢手錶！"
...
s.CHARACTERS.GENERIC.DESCRIBE.GOLDENKNIFE = "穿刺從未如此花哨！"
...
s.CHARACTERS.GENERIC.DESCRIBE.HAT_BOX = "為了你所有穿的盒子！"
...
s.CHARACTERS.GENERIC.DESCRIBE.SPYKUNAI = "我必須學會如何使用這個忍者武器。"
...
s.CHARACTERS.GENERIC.DESCRIBE.SPYCICLE = "這當武器是非常危險的。"
...
s.NAMES.HAT_BOX = "盒子戲法"
_G.ChinesePlus.RenameRecipe("HAT_BOX", "原來的隱形裝置。")

s.NAMES.KNIFE = "蝴蝶刀"
_G.ChinesePlus.RenameRecipe("KNIFE", "不玩陰的可以做這個。")

s.NAMES.GOLDENKNIFE = "澳元素刀"
_G.ChinesePlus.RenameRecipe("GOLDENKNIFE", "不是真的澳元素刀。")

s.NAMES.SPYKUNAI = "密謀者的苦無"
_G.ChinesePlus.RenameRecipe("SPYKUNAI", "從倒下的敵人吸取生命。")

s.NAMES.SPYCICLE = "寒冽冰錐"
_G.ChinesePlus.RenameRecipe("SPYCICLE", "冰重組為殺人凶器。")

s.CHARACTERS.GENERIC.DESCRIBE.SPY =
{
  GENERIC = "你好, %s!",
  ATTACKER = "那個 %s 看起來很狡猾...",
  MURDERER = "凶手!",
  REVIVER = "%s 在使用他的力量。",
  GHOST = "別那樣看看我。, %s! 我正在努力。",
  FIRESTARTER = "%s 只是要求了燒烤。",
}
