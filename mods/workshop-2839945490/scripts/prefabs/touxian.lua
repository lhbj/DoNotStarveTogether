...
local function fn()
	...
	inst.Yzhou = net_float(inst.GUID, "Z_R.Yzhou", "Yzhou_N")
	inst.DaXiao = net_byte(inst.GUID, "Z_R.DaXiao", "DaXiao_N")
	inst.Color_C = net_smallbyte(inst.GUID, "Z_R.Color_C", "Color_C")
	inst.Color_D = net_bytearray(inst.GUID, "Z_R.Color_D", "Color_D")
	inst:ListenForEvent("Color_D", Text_color)
	inst.YuYan = net_string(inst.GUID, "Z_R.YuYan", "YuYan_N")
	inst:ListenForEvent("YuYan_N", Text_K)

	inst.YuYan_A = net_string(inst.GUID, "Z_R.YuYan_A", "YuYan_A")
