local assets=
{
    Asset("ANIM", "anim/baby_koalefant_winter.zip"),
...
local function GetGrowTime()
    return GetRandomWithVariance(TUNING.BABYBEEFALO_GROW_TIME.base*3, TUNING.BABYBEEFALO_GROW_TIME.random)
end
...
--    inst.Transform:SetFourFaced()
    ...
    inst.AnimState:SetBuild("baby_koalefant_winter")
...
return Prefab( "common/monsters/baby_koalefant_winter", fn, assets, prefabs)  
